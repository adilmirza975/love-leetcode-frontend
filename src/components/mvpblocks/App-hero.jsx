...
export default function AppHero() {
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setStats((prev) => {
        ...
        if (newUsers === 200 && newSubmissions === 1200 && newNetworks === 150) {
  ...
  return (
    <section className="relative flex min-h-screen w-full flex-col items-center overflow-hidden bg-black py-16 text-white sm:px-6 lg:px-8 lg:py-2">
      ...
      <div className="fadein-blur relative z-11 mx-auto mb-10 h-[300px] w-[300px] lg:absolute lg:right-1/2 lg:top-[60%] lg:mx-0 lg:mb-0 lg:h-[500px] lg:w-[500px] lg:-translate-y-2/3 lg:translate-x-1/2">
        <img
          src="./Hero-Cube.webp"
          alt="Nexus Platform 3D Visualization"
          className="h-[90%] w-[90%] object-contain drop-shadow-[0_0_35px_#3358ea85] transition-all duration-1000 hover:scale-110"
        />
        <motion.div
